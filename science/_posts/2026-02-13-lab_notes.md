...
In a previous [post]({% post_url /science/2026-01-20-lab_notes %}) I showed, in the context of vision transformers on imagenet, that information about labels is _present_ in the CLS tokens of layers throughout the network, but this information is not _used_ by the final network outputs.
